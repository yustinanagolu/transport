      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <button onClick={() => onViewChange('home')} className="hover:text-blue-400 transition">Mwanzo</button>
            </li>
            <li>
              <button onClick={() => onViewChange('huduma')} className="hover:text-blue-400 transition">Huduma Zetu</button>
            </li>
            <li>
              <button onClick={() => onViewChange('kuhusu')} className="hover:text-blue-400 transition">Kuhusu Sisi</button>
            </li>
            <li>
              <button onClick={() => onViewChange('home')} className="hover:text-blue-400 transition">Mawasiliano</button>
            </li>
          </ul>
        </div>
        <div>
