        ...
        <div>
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <button
              ...
              className="bg-blue-600 hover:bg-blue-500 text-white font-semibold px-6 py-3 rounded-lg shadow-lg transition hover:shadow-blue-500/25"
            >
              Aagiza Usafiri Sasa
            </button>
            <button className="border border-slate-600 hover:border-slate-400 text-slate-200 font-semibold px-6 py-3 rounded-lg transition">
              Fuatilia Mizigo (Track)
            </button>
          </div>
        </div>

        {/* Upande wa Kadi ya Takwimu / Picha */}
